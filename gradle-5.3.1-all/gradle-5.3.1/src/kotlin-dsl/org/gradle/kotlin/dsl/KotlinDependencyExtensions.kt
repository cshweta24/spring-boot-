...
/**
 * The version of the Kotlin compiler embedded in gradle-kotlin-dsl (currently _1.3.21_).
 */
val embeddedKotlinVersion = "1.3.21"


/**
 * Builds the dependency notation for the named Kotlin [module] at the embedded version (currently _1.3.21_).
 *
 ...
 *
 * For example: `plugins { kotlin("jvm") version "1.3.21" }`
 *
 ...
 *
 * Equivalent to `id("org.gradle.kotlin.embedded-kotlin") version "1.2.5"`
 *
 * You can also use `` `embedded-kotlin` version "1.2.5" `` if you want to use a different version.
 *
...
val PluginDependenciesSpec.`embedded-kotlin`: PluginDependencySpec
    get() = id("org.gradle.kotlin.embedded-kotlin") version "1.2.5"


/**
 * The `kotlin-dsl` plugin.
 *
 * Equivalent to `id("org.gradle.kotlin.kotlin-dsl") version "1.2.5"`
 *
 * You can also use `` `kotlin-dsl` version "1.2.5" `` if you want to use a different version.
 *
 * @see org.gradle.kotlin.dsl.plugins.dsl.KotlinDslPlugin
 */
val PluginDependenciesSpec.`kotlin-dsl`: PluginDependencySpec
    get() = id("org.gradle.kotlin.kotlin-dsl") version "1.2.5"


/**
 * The `kotlin-dsl.base` plugin.
 *
 * Equivalent to `id("org.gradle.kotlin.kotlin-dsl.base") version "1.2.5"`
 *
 * You can also use `` `kotlin-dsl-base` version "1.2.5" `` if you want to use a different version.
 *
...
val PluginDependenciesSpec.`kotlin-dsl-base`: PluginDependencySpec
    get() = id("org.gradle.kotlin.kotlin-dsl.base") version "1.2.5"


/**
 * The `kotlin-dsl.precompiled-script-plugins` plugin.
 *
 * Equivalent to `id("org.gradle.kotlin.kotlin-dsl.precompiled-script-plugins") version "1.2.5"`
 *
 * You can also use `` `kotlin-dsl-precompiled-script-plugins` version "1.2.5" `` if you want to use a different version.
 *
...
val PluginDependenciesSpec.`kotlin-dsl-precompiled-script-plugins`: PluginDependencySpec
    get() = id("org.gradle.kotlin.kotlin-dsl.precompiled-script-plugins") version "1.2.5"
